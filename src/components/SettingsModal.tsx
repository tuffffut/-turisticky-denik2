                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 p-3 rounded-xl bg-stone-950/60 border border-stone-800">
                  <div>
                    ...
                    <p className="text-[11px] text-stone-400 mt-0.5">
                      Oprava chybných pohoří, automatické přehodnocení podle GPS a hromadné přejmenování.
                    </p>
                  </div>
                  <button
                    type="button"
                    ...
                    className="px-3 py-1.5 rounded-lg bg-stone-800 hover:bg-stone-700 text-stone-200 text-xs font-medium border border-stone-700 transition-colors cursor-pointer shrink-0"
                  >
                    Otevřít správce pohoří
                  </button>
                </div>
              )}
